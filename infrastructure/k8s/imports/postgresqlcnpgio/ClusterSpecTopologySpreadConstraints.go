...
type ClusterSpecTopologySpreadConstraints struct {
	...
	LabelSelector *ClusterSpecTopologySpreadConstraintsLabelSelector `field:"optional" json:"labelSelector" yaml:"labelSelector"`
