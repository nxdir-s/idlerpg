...
type PoolerSpecTemplateSpecInitContainersSecurityContext struct {
	...
	// Note that this field cannot be set when spec.os.name is windows.
	AppArmorProfile *PoolerSpecTemplateSpecInitContainersSecurityContextAppArmorProfile `field:"optional" json:"appArmorProfile" yaml:"appArmorProfile"`
	...
	//
	Capabilities *PoolerSpecTemplateSpecInitContainersSecurityContextCapabilities `field:"optional" json:"capabilities" yaml:"capabilities"`
	...
	// Note that this field cannot be set when spec.os.name is windows.
	SeccompProfile *PoolerSpecTemplateSpecInitContainersSecurityContextSeccompProfile `field:"optional" json:"seccompProfile" yaml:"seccompProfile"`
	...
	// PodSecurityContext, the value specified in SecurityContext takes precedence.
	// Note that this field cannot be set when spec.os.name is windows.
	SeLinuxOptions *PoolerSpecTemplateSpecInitContainersSecurityContextSeLinuxOptions `field:"optional" json:"seLinuxOptions" yaml:"seLinuxOptions"`
	// The Windows specific settings applied to all containers.
	//
	// If unspecified, the options from the PodSecurityContext will be used.
	// If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.
	// Note that this field cannot be set when spec.os.name is linux.
	WindowsOptions *PoolerSpecTemplateSpecInitContainersSecurityContextWindowsOptions `field:"optional" json:"windowsOptions" yaml:"windowsOptions"`
}
