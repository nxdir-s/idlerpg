...
type ClusterSpecMonitoringPodMonitorMetricRelabelings struct {
	...
	//
	// Default: "Replace".
	Action ClusterSpecMonitoringPodMonitorMetricRelabelingsAction `field:"optional" json:"action" yaml:"action"`
