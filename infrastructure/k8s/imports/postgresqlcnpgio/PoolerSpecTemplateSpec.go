...
type PoolerSpecTemplateSpec struct {
	// List of containers belonging to the pod.
	//
	// Containers cannot currently be added or removed.
	// There must be at least one container in a Pod.
	// Cannot be updated.
	Containers *[]*PoolerSpecTemplateSpecContainers `field:"required" json:"containers" yaml:"containers"`
	...
	Affinity *PoolerSpecTemplateSpecAffinity `field:"optional" json:"affinity" yaml:"affinity"`
	...
	DnsConfig *PoolerSpecTemplateSpecDnsConfig `field:"optional" json:"dnsConfig" yaml:"dnsConfig"`
	...
	EphemeralContainers *[]*PoolerSpecTemplateSpecEphemeralContainers `field:"optional" json:"ephemeralContainers" yaml:"ephemeralContainers"`
	// HostAliases is an optional list of hosts and IPs that will be injected into the pod's hosts file if specified.
	HostAliases *[]*PoolerSpecTemplateSpecHostAliases `field:"optional" json:"hostAliases" yaml:"hostAliases"`
	...
	ImagePullSecrets *[]*PoolerSpecTemplateSpecImagePullSecrets `field:"optional" json:"imagePullSecrets" yaml:"imagePullSecrets"`
	...
	InitContainers *[]*PoolerSpecTemplateSpecInitContainers `field:"optional" json:"initContainers" yaml:"initContainers"`
	...
	Os *PoolerSpecTemplateSpecOs `field:"optional" json:"os" yaml:"os"`
	...
	Overhead *map[string]PoolerSpecTemplateSpecOverhead `field:"optional" json:"overhead" yaml:"overhead"`
	...
	ReadinessGates *[]*PoolerSpecTemplateSpecReadinessGates `field:"optional" json:"readinessGates" yaml:"readinessGates"`
	...
	ResourceClaims *[]*PoolerSpecTemplateSpecResourceClaims `field:"optional" json:"resourceClaims" yaml:"resourceClaims"`
	...
	// gate.
	Resources *PoolerSpecTemplateSpecResources `field:"optional" json:"resources" yaml:"resources"`
	...
	SchedulingGates *[]*PoolerSpecTemplateSpecSchedulingGates `field:"optional" json:"schedulingGates" yaml:"schedulingGates"`
	// SecurityContext holds pod-level security attributes and common container settings.
	//
	// Optional: Defaults to empty.  See type description for default values of each field.
	// Default: empty.  See type description for default values of each field.
	//
	SecurityContext *PoolerSpecTemplateSpecSecurityContext `field:"optional" json:"securityContext" yaml:"securityContext"`
	...
	Tolerations *[]*PoolerSpecTemplateSpecTolerations `field:"optional" json:"tolerations" yaml:"tolerations"`
	// TopologySpreadConstraints describes how a group of pods ought to spread across topology domains.
	//
	// Scheduler will schedule pods in a way which abides by the constraints.
	// All topologySpreadConstraints are ANDed.
	TopologySpreadConstraints *[]*PoolerSpecTemplateSpecTopologySpreadConstraints `field:"optional" json:"topologySpreadConstraints" yaml:"topologySpreadConstraints"`
	// List of volumes that can be mounted by containers belonging to the pod.
	//
	// More info: https://kubernetes.io/docs/concepts/storage/volumes
	Volumes *[]*PoolerSpecTemplateSpecVolumes `field:"optional" json:"volumes" yaml:"volumes"`
}
