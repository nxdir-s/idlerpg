...
type ClusterSpecProjectedVolumeTemplateSourcesConfigMap struct {
	...
	Items *[]*ClusterSpecProjectedVolumeTemplateSourcesConfigMapItems `field:"optional" json:"items" yaml:"items"`
