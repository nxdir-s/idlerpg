...
type ClusterSpecManagedServicesAdditionalServiceTemplateSpec struct {
	...
	//
	// If an address is specified manually, is in-range (as per
	...
	//
	// If an address is specified manually, is
	...
	//
	// More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
	Ports *[]*ClusterSpecManagedServicesAdditionalServiceTemplateSpecPorts `field:"optional" json:"ports" yaml:"ports"`
	...
	SessionAffinityConfig *ClusterSpecManagedServicesAdditionalServiceTemplateSpecSessionAffinityConfig `field:"optional" json:"sessionAffinityConfig" yaml:"sessionAffinityConfig"`
	// TrafficDistribution offers a way to express preferences for how traffic is distributed to Service endpoints.
	//
	// Implementations can use this field as a
