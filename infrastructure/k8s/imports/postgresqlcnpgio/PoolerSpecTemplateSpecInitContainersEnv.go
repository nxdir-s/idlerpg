...
type PoolerSpecTemplateSpecInitContainersEnv struct {
	...
	ValueFrom *PoolerSpecTemplateSpecInitContainersEnvValueFrom `field:"optional" json:"valueFrom" yaml:"valueFrom"`
}
