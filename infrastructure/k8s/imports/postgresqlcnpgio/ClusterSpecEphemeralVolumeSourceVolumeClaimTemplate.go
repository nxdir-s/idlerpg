...
type ClusterSpecEphemeralVolumeSourceVolumeClaimTemplate struct {
	...
	// are also valid here.
	Spec *ClusterSpecEphemeralVolumeSourceVolumeClaimTemplateSpec `field:"required" json:"spec" yaml:"spec"`
