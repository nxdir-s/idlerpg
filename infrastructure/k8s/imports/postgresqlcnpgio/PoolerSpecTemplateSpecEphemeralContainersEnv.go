...
type PoolerSpecTemplateSpecEphemeralContainersEnv struct {
	...
	ValueFrom *PoolerSpecTemplateSpecEphemeralContainersEnvValueFrom `field:"optional" json:"valueFrom" yaml:"valueFrom"`
}
