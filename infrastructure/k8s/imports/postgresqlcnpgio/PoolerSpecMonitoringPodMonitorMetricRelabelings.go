...
type PoolerSpecMonitoringPodMonitorMetricRelabelings struct {
	...
	//
	// Default: "Replace".
	Action PoolerSpecMonitoringPodMonitorMetricRelabelingsAction `field:"optional" json:"action" yaml:"action"`
